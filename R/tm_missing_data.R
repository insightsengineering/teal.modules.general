...
srv_missing_data <- function(id,
  ...
  moduleServer(id, function(input, output, session) {
    ...
    decorated_combination_plot_dims_q <- set_chunk_dims(pws2, decorated_combination_plot_q) # nolint: object_length_linter.

    decorated_by_subject_plot_dims_q <- set_chunk_dims(pws3, decorated_by_subject_plot_q) # nolint: object_length_linter.
