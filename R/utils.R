...
#' @param ggplot2_args (`ggplot_args`) class list, generated by \code{ggplot2_args()} function.
...
#'
#' @description A validation function.
#' @param basic_table_args (`basic_table_args`) class list, generated by \code{basic_table_args_fun()}.
#' Or list of such objects.
...
#' @param basic_table_args (`basic_table_args`)
#' @param table_name (`character`)
#' @param nest_table_args (`basic_table_args`)
#' @export
