...
ggplot_args <- function(labs = list(), theme = list()) {
  ...
  ggplot2_labs <- c(utils::getFromNamespace(".all_aesthetics", "ggplot2"), methods::formalArgs(ggplot2::labs))
...
#' Building a list of the class \code{basic_table_args}
#'
#' @description This function has to be used to build an input for a \code{basic_table_args} argument.
#' The \code{basic_table_args} argument is part of every module which contains any \code{rtables} tables
#' Arguments are validated to match its \code{rtables} equivalent.
#'
#' @param ... arguments compatible with \code{rtables::basic_table()}.
#' @return list of the \code{basic_table_args} class.
#'
#' @export
...
#' @param ggplot2_args (\code{ggplot_args}) class list, generated by \code{ggplot2_args()} function.
#' Or list of such objects.
#' @param plot_names (`character`) vector of all plot names.
#' Defaults to NULL so not multi-plot in the module.
#'
#' @return nothing
#' @export
...
#'
#' @description A validation function.
#' @param basic_table_args (\code{basic_table_args}) class list, generated by \code{basic_table_args_fun()}.
#' Or list of such objects.
#' @param table_names (`character`) vector of all tables names.
#' Defaults to NULL so not multi-plot in the module.
#'
#' @return nothing
#' @export
validate_basic_table_args <- function(basic_table_args, table_names = NULL) {
  ...
  stop_if_not(
    list(
      is_basic_table_args || (is_nested_table_args && (all(names(basic_table_args) %in% c("default", table_names)))),
...
#' @param basic_table_args (\code{basic_table_args})
#' @param table_name (`character`)
#' @param nest_table_args (\code{basic_table_args})
#' @export
