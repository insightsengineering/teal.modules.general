...
* Modified the trend line feature in `tm_g_scatterplot` to display the raw equation that will display the actual y value when the actual x values are plugged in.
