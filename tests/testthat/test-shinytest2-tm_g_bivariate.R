...
testthat::test_that("e2e - tm_g_bivariate: Coloring options are hidden when coloring is toggled off.", {
  ...
  testthat::expect_true(
    app_driver$is_visible(
      app_driver$namespaces(TRUE)$module("color-dataset_CO2_singleextract-select_input")
    )
  )
  testthat::expect_true(
    app_driver$is_visible(
      app_driver$namespaces(TRUE)$module("size-dataset_CO2_singleextract-select_input")
    )
  )
  testthat::expect_true(
    app_driver$is_visible(
      app_driver$namespaces(TRUE)$module("fill-dataset_CO2_singleextract-select_input")
    )
  )
...
testthat::test_that("e2e - tm_g_bivariate: Facetting options are hidden when facet is toggled off.", {
  ...
  testthat::expect_true(
    app_driver$is_visible(
      app_driver$namespaces(TRUE)$module("row_facet-dataset_CO2_singleextract-select")
    )
  )
  testthat::expect_true(
    app_driver$is_visible(
      app_driver$namespaces(TRUE)$module("col_facet-dataset_CO2_singleextract-select")
    )
  )
  testthat::expect_true(app_driver$is_visible(app_driver$namespaces(TRUE)$module("free_x_scales")))
  testthat::expect_true(app_driver$is_visible(app_driver$namespaces(TRUE)$module("free_y_scales")))
  ...
  testthat::expect_false(app_driver$is_visible(app_driver$namespaces(TRUE)$module("free_x_scales")))
  testthat::expect_false(app_driver$is_visible(app_driver$namespaces(TRUE)$module("free_y_scales")))
