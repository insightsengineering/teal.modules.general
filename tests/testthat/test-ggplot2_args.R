...
ggplot2_args_single <- ggplot_args(labs = list(title = "TEST",
                                               caption = "SOMTHING",
                                               subtitle = "aa"),
                                   theme = list())

ggplot2_args_multi <- list(default = ggplot_args(labs = list(title = "TEST",
                                                             caption = "SOMTHING",
                                                             subtitle = "aa"),
                                                 theme = list()),
                           plot1 = ggplot_args(labs = list(title = "TEST",
                                                           caption = "SOMTHING",
                                                           subtitle = "aa"),
                                               theme = list())
)

ggplot2_args_multi_wrong <- list(default_WRONG = ggplot_args(labs = list(title = "TEST",
                                                                         caption = "SOMTHING",
                                                                         subtitle = "aa"),
                                                             theme = list()),
                                 plot1 = ggplot_args(labs = list(title = "TEST",
...
testthat::test_that("validate_ggplot2_args", {
  ...
  error_msg = paste0('Error: is_ggplot2_args || (is_nested_ggplot2_args && (all(names(ggplot2_args)',
  ...
  testthat::expect_error(validate_ggplot2_args(list()), error_msg)
})
...
testthat::test_that("get_expr_ggplot2_args, miniaml requirement is to provide ggplot2_args",{
  ...
  testthat::expect_identical(get_expr_ggplot2_args(ggplot2_args = ggplot2_args_single),
                             quote(gg + labs(title = "TEST", caption = "SOMTHING", subtitle = "aa")))
  testthat::expect_identical(get_expr_ggplot2_args(ggplot2_args = ggplot2_args_multi),
                             quote(gg + labs(title = "TEST", caption = "SOMTHING", subtitle = "aa")))
})

testthat::test_that("get_expr_ggplot2_args, additional validation, assumed that validate_ggplot2_args is already used",{
  get_expr_ggplot2_args(ggplot2_args = list()),
})
...
testthat::test_that("get_expr_ggplot2_args  ggtheme = NULL and all theme empty",{
  testthat::expect_identical(get_expr_ggplot2_args(plot_name = "STH",
  ...
  testthat::expect_identical(get_expr_ggplot2_args(plot_name = "default",
                                                   chunk_plot_name = as.name("g"),
  ...
  testthat::expect_identical(get_expr_ggplot2_args(plot_name = "WRONG_NAME",
                                                   chunk_plot_name = as.name("g"),
                                                   ggplot2_args = ggplot2_args_multi,
                                                   nest_ggplot2_args = NULL,
                                                   ggtheme = NULL),
