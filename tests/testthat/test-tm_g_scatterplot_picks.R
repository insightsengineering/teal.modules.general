testthat::describe("tm_g_scatterplot module creation", {
  it("creates a teal_module object", {
    testthat::expect_s3_class(
      tm_g_scatterplot(
        ...
        mock_teal_picks(select_multiple = FALSE),
        color_by = mock_teal_picks(select_multiple = FALSE),
        size_by = mock_teal_picks(select_multiple = FALSE),
  ...
  it("creates a module with datanames taken from data extracts", {
    mod <- tm_g_scatterplot(
      ...
      color_by = mock_teal_picks(dataname = "C", select_multiple = FALSE),
      size_by = mock_teal_picks(dataname = "D", select_multiple = FALSE),
      row_facet = mock_teal_picks(dataname = "A", select_multiple = FALSE),
      col_facet = mock_teal_picks(dataname = "B", select_multiple = FALSE)
    )
...
testthat::describe("tm_g_scatterplot module server behavior", {
  ...
  it("server function handles color_by option", {
    ...
    mod <- tm_g_scatterplot(
      x = teal.picks::picks(
        teal.picks::datasets("test_data", "test_data"),
        teal.picks::variables(c("x_var", "y_var", "color_var"), "x_var")
      ),
      y = teal.picks::picks(
        teal.picks::datasets("test_data", "test_data"),
        teal.picks::variables(c("x_var", "y_var", "color_var"), "y_var")
      ),
      color_by = teal.picks::picks(
        teal.picks::datasets("test_data", "test_data"),
        teal.picks::variables(c("x_var", "y_var", "color_var"), "color_var")
      )
    )
  ...
  it("server function handles size_by option", {
    ...
    mod <- tm_g_scatterplot(
      x = teal.picks::picks(
        teal.picks::datasets("test_data", "test_data"),
        teal.picks::variables(c("x_var", "y_var", "size_var"), "x_var")
      ),
      y = teal.picks::picks(
        teal.picks::datasets("test_data", "test_data"),
        teal.picks::variables(c("x_var", "y_var", "size_var"), "y_var")
      ),
      size_by = teal.picks::picks(
        teal.picks::datasets("test_data", "test_data"),
        teal.picks::variables(c("x_var", "y_var", "size_var"), "size_var")
      )
    )
