        ...
        categorical_var = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            ...
            choices = variable_choices(
              data@env$ADSL,
              subset = names(Filter(isTRUE, sapply(data@env$ADSL, is.factor)))
            ),
            selected = "RACE",
            multiple = FALSE,
            fixed = FALSE
      ...
      tm_outliers(
        ...
        outlier_var = list(
          ...
          teal.transform::data_extract_spec(
            ...
            select = select_spec(
              label = "Select variable:",
              choices = variable_choices(data@env$ADLB, c("AVAL", "CHG2")),
              selected = "AVAL",
              multiple = FALSE,
              fixed = FALSE
            )
      ...
      tm_outliers(
        ...
        outlier_var = list(
          teal.transform::data_extract_spec(
            ...
            select = select_spec(
              label = "Select variable:",
              choices = variable_choices(data@env$ADRS, c("ADY", "EOSDY")),
              selected = "ADY",
              fixed = FALSE
            )
          ),
        ...
        categorical_var = list(
          teal.transform::data_extract_spec(
            ...
            select = select_spec(
              label = "Select variables:",
              choices = variable_choices(data@env$ADRS, c("ARM", "ACTARM")),
              selected = "ARM",
              multiple = FALSE,
              fixed = FALSE
            )
          ...
          teal.transform::data_extract_spec(
            ...
            select = select_spec(
              ...
              choices = variable_choices(
                data@env$ADLB,
                subset = names(Filter(isTRUE, sapply(data@env$ADLB, is.factor)))
              ),
              selected = "RACE",
              multiple = FALSE,
              fixed = FALSE
