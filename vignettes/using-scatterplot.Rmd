...
datanames(data) <- c("ADSL", "ADSL2", "ADRS", "ADTTE", "ADLB")
join_keys(data) <- default_cdisc_join_keys[c("ADSL", "ADRS", "ADTTE", "ADLB")]
join_keys(data)["ADSL2"] <- get_cdisc_keys("ADSL")
# nolint end
```
    ...
    modules(
      ...
      tm_g_scatterplot(
        ...
        y = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            label = "Select variable:",
            choices = variable_choices(data[["ADSL2"]], c("AGE", "SEX")),
            selected = "AGE",
            multiple = FALSE,
            fixed = FALSE
          )
