...
```{r library, echo=TRUE, message=FALSE, warning=FALSE, results="hide", eval = requireNamespace("ggpmisc", quietly = TRUE) && requireNamespace("ggExtra") && requireNamespace("colourpicker")}
...
```{r data, echo=TRUE, message=FALSE, warning=FALSE, results="hide", eval = requireNamespace("ggpmisc", quietly = TRUE) && requireNamespace("ggExtra") && requireNamespace("colourpicker")}
data <- teal_data()
data <- within(data, {
...
```{r app, echo=TRUE, message=FALSE, warning=FALSE, results="hide", eval = requireNamespace("ggpmisc", quietly = TRUE) && requireNamespace("ggExtra") && requireNamespace("colourpicker")}
