    ...
    modules(
      ...
      tm_g_scatterplot(
        ...
        x = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            ...
            choices = variable_choices(data@env$ADSL, c("AGE", "BMRKR1", "BMRKR2")),
            selected = "AGE",
            multiple = FALSE,
            fixed = FALSE
          )
        ...
        color_by = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            ...
            choices = variable_choices(data@env$ADSL, c("RACE", "SEX")),
            selected = NULL,
            multiple = TRUE,
            fixed = FALSE
          )
      ...
      tm_g_scatterplot(
        ...
        x = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            label = "Select variable:",
            choices = variable_choices(data@env$ADSL, c("BMRKR1", "BMRKR2")),
            selected = "BMRKR1",
            multiple = FALSE,
            fixed = FALSE
          )
        ...
        y = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            label = "Select variable:",
            choices = variable_choices(data@env$ADSL2, c("AGE", "SEX")),
            selected = "AGE",
            multiple = FALSE,
            fixed = FALSE
          )
      ...
      tm_g_scatterplot(
        ...
        color_by = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            label = "Select variable:",
            choices = variable_choices(data@env$ADSL, c("AGE", "SEX")),
            selected = "AGE",
            multiple = FALSE,
            fixed = FALSE
          )
      ...
      tm_g_scatterplot(
        ...
        x = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            label = "Select variable:",
            choices = variable_choices(data@env$ADSL, c("SEX", "AGE", "BMRKR1", "COUNTRY")),
            selected = "AGE",
            multiple = FALSE,
            fixed = FALSE
          )
      ...
      tm_g_scatterplot(
        ...
        x = teal.transform::data_extract_spec(
          dataname = "ADRS",
          select = select_spec(
            choices = variable_choices(data@env$ADRS, c("AVAL", "BMRKR1", "BMRKR2")),
            selected = "AVAL",
            multiple = FALSE,
            fixed = FALSE,
            label = "Select variable:"
        ...
        color_by = teal.transform::data_extract_spec(
          dataname = "ADRS",
          select = select_spec(
            choices = variable_choices(data@env$ADRS, c("AGE", "SEX", "RACE")),
            selected = NULL,
            multiple = FALSE,
            fixed = FALSE,
            label = "Select variable:"
      ...
      tm_g_scatterplot(
        ...
        color_by = teal.transform::data_extract_spec(
          ...
          select = select_spec(
            choices = variable_choices(data@env$ADLB, c("RACE", "SEX")),
            selected = "SEX",
            multiple = FALSE,
            fixed = FALSE,
            label = "Select variable:"
